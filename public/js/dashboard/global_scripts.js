...
let initTinyMc = function (editingInp = false) {
    tinymce.init({
        ...
        toolbar: [
            ...
            "outdent indent | bullist numlist | outdent indent | blockquote subscript superscript | advlist | autolink | lists charmap ",
        ],
...
$(document).ready(function () {
    ...
    $(
        "#submitted-form,.submitted-form,#role_form_update,#role_form_add"
